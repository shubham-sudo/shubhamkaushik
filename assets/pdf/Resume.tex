...
\begin{itemize}[topsep=0pt, itemsep=0pt, parsep=0.2em]
	...
	\item \textbf{Markup Languages}: HTML, CSS, JavaScript, YAML, \LaTeX, Markdown
	\item \textbf{Databases}: RocksDB, Postgres, MongoDB, Redis, SQLite, ORM
	\item \textbf{Tools \& Systems}: Asyncio, Git, Docker, AWS
\end{itemize}
...
\publication{TPCTC 2025}{Alexander H. Ott, \textbf{Shubham Kaushik}, Boao Chen, and Subhadeep Sarkar. \href{https://api.semanticscholar.org/CorpusID:282201482}{\textit{\textcolor{blueviolet}{Tectonic: Bridging Synthetic and Real-World Workloads for Key-Value Benchmarking}}}, TPC Technology Conference on Performance Evaluation \& Benchmarking}
